...
AddLoadCallback(function() 
		...
		AIData.points,AIData.enemyTowers,AIData.allyTowers,AIData.allyBarracks,AIData.enemyBarracks = {},{},{},{},{}
		for i=1, objManager.maxObjects, 1 do
			...
			if candidate ~= nil and candidate.valid == true then
				...
				--barracks
				elseif candidate.type == "obj_BarracksDampener" and candidate.dead == false and candidate.bTargetable == true then
					if candidate.team == TEAM_ENEMY then AIData.enemyBarracks[#AIData.enemyBarracks+1] = candidate
					elseif candidate.team == myHero.team then AIData.allyBarracks[#AIData.allyBarracks+1] = candidate end					
				--dom points
				...
				elseif candidate.type == "obj_HQ" then
					if candidate.team == TEAM_ENEMY then AIData.enemyNexus = candidate 
					elseif candidate.team == myHero.team then AIData.allyNexus = candidate end
				end
			end
		end
