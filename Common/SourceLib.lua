...
-- Update script
if autoUpdate then
    SourceUpdater("SourceLib", version, "raw.githubusercontent.com", "/gbilbao/Bilbao/master/BoL1/Common/SourceLib.lua", LIB_PATH .. "SourceLib.lua", "/gbilbao/Bilbao/master/BoL1/Common/SourceLib.version"):SetSilent(silentUpdate):CheckUpdate()
end
