...
AIFind.safeTower2 = function(pos)
	return AIRoutine.findMatch(AIData.allyTowers,
		function(this) return this.valid == true and this.health > 450 and AIRoutine.distance(AIData.allySpawn,pos) > AIRoutine.distance(AIData.allySpawn,this) + 1500 and AIFind.enemy(this,1000) == nil end,
		function(a,b) return AIRoutine.distance(pos,a) < AIRoutine.distance(pos,b) end)
end
...
AIFind.allyTowers = function(pos,range)
		return AIRoutine.findMatches(AIData.allyTowers,function(this) return this.dead == false and AIRoutine.distance(pos,this) <= range end)
end

AIFind.enemyTowers = function(pos,range)
		return AIRoutine.findMatches(AIData.enemyTowers,function(this) return this.dead == false and AIRoutine.distance(pos,this) <= range end)
end

AIFind.allyBarracks = function(pos,range)
	return AIRoutine.findMatch(AIData.allyBarracks,
		function(this) return this.valid == true and this.dead == false and AIRoutine.distance(pos,this) <= range end,
		--check distance
		function(a,b) return AIRoutine.distance(pos,a) < AIRoutine.distance(pos,b) end)
end
	
AIFind.enemyBarracks = function(pos,range)
	return AIRoutine.findMatch(AIData.enemyBarracks,
		function(this) return this.valid == true and this.dead == false and AIRoutine.distance(pos,this) <= range end,
		--check distance
		function(a,b) return AIRoutine.distance(pos,a) < AIRoutine.distance(pos,b) end)
end
...
--UPDATEURL=
--HASH=13D6C6D6F6A00B2A0F37981ADABBB84C
